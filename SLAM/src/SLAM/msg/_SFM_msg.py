"""autogenerated by genpy from SLAM/SFM_msg.msg. Do not edit."""
import sys
...
class SFM_msg(genpy.Message):
  _md5sum = "0f7da4217e07aa4196e821a466e25362"
  _type = "SLAM/SFM_msg"
...
"""
  __slots__ = ['header','size','P','image']
  _slot_types = ['std_msgs/Header','uint32','float32[]','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SFM_msg, self).__init__(*args, **kwds)
